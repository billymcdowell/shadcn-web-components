...
export class AlertTitle extends LitElement {
  static styles = [tokensBase, css`:host { display: block; margin-bottom: var(--spacing-1); color: inherit; font-family: var(--font-sans); font-weight: var(--font-medium); line-height: var(--leading-none); letter-spacing: -0.01em; }`];
...
export class AlertDescription extends LitElement {
  static styles = [tokensBase, css`:host { display: block; color: color-mix(in oklch, currentColor 80%, transparent); font-family: var(--font-sans); font-size: var(--font-size-sm); line-height: var(--leading-relaxed); }`];
  render() { return html`<slot></slot>`; }
}

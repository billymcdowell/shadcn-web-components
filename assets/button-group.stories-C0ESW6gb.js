import{i as H,a as L,x as t}from"./iframe-CBkYFfHe.js";import{t as V}from"./custom-element-C028faeO.js";import{n as _}from"./property-DkYxKTO5.js";import{t as T}from"./index-DHlp-d2y.js";import"./button-BilKkZtN.js";import"./preload-helper-BBXEHTOU.js";var D=Object.defineProperty,E=Object.getOwnPropertyDescriptor,O=(p,o,l,r)=>{for(var n=r>1?void 0:r?E(o,l):o,c=p.length-1,h;c>=0;c--)(h=p[c])&&(n=(r?h(o,l,n):h(n))||n);return r&&n&&D(o,l,n),n};let u=class extends L{constructor(){super(...arguments),this.orientation="horizontal"}render(){return t`
      <div
        part="button-group"
    ...
    `];O([_({type:String})],u.prototype,"orientation",2);u=O([V("shadcn-button-group")],u);const A={title:"Components/Button Group",component:"shadcn-button-group",tags:["autodocs"],argTypes:{orientation:{control:"select",options:["horizontal","vertical"],description:"Orientation of the button group"}},parameters:{docs:{description:{component:"A container for grouping related buttons together with merged borders."}}}},e={render:()=>t`
...
}`,...(M=(S=d.parameters)==null?void 0:S.docs)==null?void 0:M.source}}};const q=["Horizontal","Vertical","WithIcons","DifferentVariants","ToolBar"];export{i as DifferentVariants,e as Horizontal,d as ToolBar,s as Vertical,a as WithIcons,q as __namedExportsOrder,A as default};

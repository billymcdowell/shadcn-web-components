import{i as F,x as H}from"./iframe-Baten_M5.js";import{t as s}from"./custom-element-C028faeO.js";import{n as $}from"./property-Cny5Lx-H.js";import{D as A,a as N,g as V,b as W,c as q,e as G,f as I}from"./dialog-content-CGEE4zzH.js";import{M as j}from"./modal-surface-CGq7x0bD.js";import{t as J,a as K}from"./index-Bkm5wONK.js";import"./button-Dp4fUmeH.js";import"./input-BUUj10M-.js";import"./preload-helper-BBXEHTOU.js";import"./state-sync-controller-DOYT6Ds6.js";import"./state-CcYsaF-H.js";import"./query-TLA3Feqw.js";import"./base-CShCMygk.js";var Q=Object.defineProperty,R=Object.getOwnPropertyDescriptor,t=(e,r,l,a)=>{for(var o=a>1?void 0:a?R(r,l):r,m=e.length-1,u;m>=0;m--)(u=e[m])&&(o=(a?u(r,l,o):u(o))||o);return a&&o&&Q(r,l,o),o};let g=class extends A{updated(e){super.updated(e),e.has("open")&&e.get("open")!==void 0&&this.dispatchEvent(new CustomEvent("sheet-open-change",{bubbles:!0,composed:!0,detail:{open:this.open}}))}};g=t([s("shadcn-sheet")],g);let f=class extends N{};f=t([s("shadcn-sheet-trigger")],f);let b=class extends V{};b=t([s("shadcn-sheet-close")],b);let c=class extends j{constructor(){super(...arguments),this.side="right",this.titleSelector="shadcn-sheet-title"}};c.styles=[...j.styles,J,K,F`
  ...
  `];t([$({type:String,reflect:!0})],c.prototype,"side",2);c=t([s("shadcn-sheet-content")],c);let v=class extends W{};v=t([s("shadcn-sheet-title")],v);let S=class extends q{};S=t([s("shadcn-sheet-description")],S);let x=class extends G{};x=t([s("shadcn-sheet-header")],x);let D=class extends I{};D=t([s("shadcn-sheet-footer")],D);const de={title:"Components/Sheet",component:"shadcn-sheet",tags:["autodocs"],argTypes:{open:{control:"boolean",description:"Whether the sheet is open."},side:{control:"select",options:["top","right","bottom","left"],description:"Viewport edge for the panel."}}},p=e=>H`
  ...
  render
}`,...(E=(C=i.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var O,z,M;d.parameters={...d.parameters,docs:{...(O=d.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    open: true,
    side: 'top'
  },
  render
}`,...(M=(z=d.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};var P,B,L;h.parameters={...h.parameters,docs:{...(P=h.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    open: true,
    side: 'bottom'
  },
  render
}`,...(L=(B=h.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};const he=["Default","Left","Top","Bottom"];export{h as Bottom,n as Default,i as Left,d as Top,he as __namedExportsOrder,de as default};

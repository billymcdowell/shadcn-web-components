import{i as d,a as r,x as a}from"./iframe-CBkYFfHe.js";import{t as e}from"./custom-element-C028faeO.js";import{t as n}from"./index-DHlp-d2y.js";import"./button-BilKkZtN.js";import"./preload-helper-BBXEHTOU.js";import"./property-DkYxKTO5.js";var R=Object.getOwnPropertyDescriptor,t=(y,x,Y,z)=>{for(var s=z>1?void 0:z?R(x,Y):x,m=y.length-1,k;m>=0;m--)(k=y[m])&&(s=k(s)||s);return s};let p=class extends r{render(){return a`
    ...
    `];b=t([e("shadcn-card-footer")],b);const I={title:"Components/Card",component:"shadcn-card",tags:["autodocs"],parameters:{docs:{description:{component:"A versatile card container for grouping related content with header, content, and footer sections."}}}},c={render:()=>a`
  ...
  \`
}`,...(O=(L=h.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};const J=["Default","WithFooter","LoginForm","ProductCard","MultipleCards"];export{c as Default,i as LoginForm,h as MultipleCards,l as ProductCard,o as WithFooter,J as __namedExportsOrder,I as default};

import{i as j,a as z,x as o}from"./iframe-B6ecvixb.js";import{t as B}from"./custom-element-C028faeO.js";import{n as t}from"./property-BCNZ7cbM.js";import{e as I}from"./query-TLA3Feqw.js";import{t as F}from"./index-DEzpxp9E.js";import"./label-BCQyCm6L.js";import"./preload-helper-BBXEHTOU.js";import"./base-CShCMygk.js";var K=Object.defineProperty,L=Object.getOwnPropertyDescriptor,a=(e,c,s,d)=>{for(var r=d>1?void 0:d?L(c,s):c,k=e.length-1,x;k>=0;k--)(x=e[k])&&(r=(d?x(c,s,r):x(r))||r);return d&&r&&K(c,s,r),r};let n=class extends z{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.required=!1,this.name="",this.value=""}render(){return o`
    ...
    `];a([I(".checkbox__input")],n.prototype,"inputElement",2);a([t({type:Boolean})],n.prototype,"checked",2);a([t({type:Boolean})],n.prototype,"disabled",2);a([t({type:Boolean})],n.prototype,"required",2);a([t({type:String})],n.prototype,"name",2);a([t({type:String})],n.prototype,"value",2);n=a([B("shadcn-checkbox")],n);const V={title:"Components/Checkbox",component:"shadcn-checkbox",tags:["autodocs"],argTypes:{checked:{control:"boolean",description:"Whether the checkbox is checked"},disabled:{control:"boolean",description:"Whether the checkbox is disabled"}},parameters:{docs:{description:{component:"A checkbox input with WCAG 2.1 AA compliant accessibility and keyboard support."}}}},i={render:()=>o`
  ...
  \`
}`,...(O=(q=b.parameters)==null?void 0:q.docs)==null?void 0:O.source}}};var P,R,W;m.parameters={...m.parameters,docs:{...(P=m.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => {
...
}`,...(W=(R=m.parameters)==null?void 0:R.docs)==null?void 0:W.source}}};const X=["Default","Checked","Disabled","WithLabel","FormExample","Interactive"];export{h as Checked,i as Default,l as Disabled,b as FormExample,m as Interactive,p as WithLabel,X as __namedExportsOrder,V as default};

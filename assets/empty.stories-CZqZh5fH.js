import{i as O,a as A,x as t}from"./iframe-Baten_M5.js";import{t as I}from"./custom-element-C028faeO.js";import{n as M}from"./property-Cny5Lx-H.js";import{t as T}from"./index-Bkm5wONK.js";import"./button-Dp4fUmeH.js";import"./preload-helper-BBXEHTOU.js";var U=Object.defineProperty,$=Object.getOwnPropertyDescriptor,u=(y,s,l,o)=>{for(var n=o>1?void 0:o?$(s,l):s,m=y.length-1,h;m>=0;m--)(h=y[m])&&(n=(o?h(s,l,n):h(n))||n);return o&&n&&U(s,l,n),n};let e=class extends A{render(){return t`
    ...
    `];u([M({type:String})],e.prototype,"heading",2);u([M({type:String})],e.prototype,"description",2);e=u([I("shadcn-empty")],e);const K={title:"Components/Empty",component:"shadcn-empty",tags:["autodocs"],parameters:{docs:{description:{component:"Display empty states when there is no content to show. Highly customizable with slots for icon, title, description, and actions."}}}},r={render:()=>t`
...
}`,...(N=(E=d.parameters)==null?void 0:E.docs)==null?void 0:N.source}}};var S,D,B;c.parameters={...c.parameters,docs:{...(S=c.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => html\`
    <div style="background: var(--background); min-height: 400px;">
      <shadcn-empty>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
}`,...(B=(D=c.parameters)==null?void 0:D.docs)==null?void 0:B.source}}};var P,W,z;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => html\`
    <div style="background: var(--background); min-height: 400px;">
      <shadcn-empty
        title="No data available"
...
}`,...(z=(W=p.parameters)==null?void 0:W.docs)==null?void 0:z.source}}};const L=["Default","WithCustomText","WithAction","WithCustomIcon","SearchResults","MultipleActions"];export{r as Default,p as MultipleActions,c as SearchResults,i as WithAction,d as WithCustomIcon,a as WithCustomText,L as __namedExportsOrder,K as default};

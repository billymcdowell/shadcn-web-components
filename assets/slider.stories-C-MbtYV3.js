import{i as W,a as K,x as d}from"./iframe-Baten_M5.js";import{t as H}from"./custom-element-C028faeO.js";import{n as o}from"./property-Cny5Lx-H.js";import{r as X}from"./state-CcYsaF-H.js";import{e as T}from"./query-TLA3Feqw.js";import{t as q,a as G}from"./index-Bkm5wONK.js";import"./label-z5LBJa38.js";import"./preload-helper-BBXEHTOU.js";import"./base-CShCMygk.js";var J=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,t=(e,a,n,i)=>{for(var r=i>1?void 0:i?Q(a,n):a,l=e.length-1,f;l>=0;l--)(f=e[l])&&(r=(i?f(a,n,r):f(r))||r);return i&&r&&J(a,n,r),r};let s=class extends K{constructor(){super(...arguments),this.value=50,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.name="",this._isDragging=!1}render(){const e=(this.value-this.min)/(this.max-this.min)*100;return d`
      <div
        part="slider"
    ...
    `];t([T(".slider__track")],s.prototype,"trackElement",2);t([T(".slider__thumb")],s.prototype,"thumbElement",2);t([o({type:Number})],s.prototype,"value",2);t([o({type:Number})],s.prototype,"min",2);t([o({type:Number})],s.prototype,"max",2);t([o({type:Number})],s.prototype,"step",2);t([o({type:Boolean})],s.prototype,"disabled",2);t([o({type:String})],s.prototype,"name",2);t([X()],s.prototype,"_isDragging",2);s=t([H("shadcn-slider")],s);const de={title:"Components/Slider",component:"shadcn-slider",tags:["autodocs"],argTypes:{value:{control:{type:"number",min:0,max:100},description:"Current value"},min:{control:"number",description:"Minimum value"},max:{control:"number",description:"Maximum value"},step:{control:"number",description:"Step increment"},disabled:{control:"boolean",description:"Whether the slider is disabled"}},parameters:{docs:{description:{component:"A slider input for selecting a value from a range with mouse/touch drag and keyboard support."}}}},c={render:()=>d`
  ...
  \`
}`,...(C=(E=p.parameters)==null?void 0:E.docs)==null?void 0:C.source}}};var M,V,j;h.parameters={...h.parameters,docs:{...(M=h.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 400px;">
      <shadcn-label>Disabled Slider</shadcn-label>
      <shadcn-slider value="60" disabled></shadcn-slider>
  ...
  \`
}`,...(j=(V=h.parameters)==null?void 0:V.docs)==null?void 0:j.source}}};var R,F,B;v.parameters={...v.parameters,docs:{...(R=v.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 400px; display: flex; flex-direction: column; gap: 1.5rem;">
      <div>
        <shadcn-label>Bass</shadcn-label>
  ...
  \`
}`,...(B=(F=v.parameters)==null?void 0:F.docs)==null?void 0:B.source}}};var I,L,A;b.parameters={...b.parameters,docs:{...(I=b.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => {
    let currentValue = 50;
...
}`,...(A=(L=b.parameters)==null?void 0:L.docs)==null?void 0:A.source}}};var O,U,N;g.parameters={...g.parameters,docs:{...(O=g.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 500px;">
      <form style="display: flex; flex-direction: column; gap: 1.5rem; padding: 1.5rem; border: 1px solid var(--border); border-radius: var(--radius-lg);">
        <h3 style="margin: 0; font-size: var(--font-size-lg); font-weight: var(--font-semibold);">
  ...
  \`
}`,...(N=(U=g.parameters)==null?void 0:U.docs)==null?void 0:N.source}}};const le=["Default","WithLabel","CustomRange","FineControl","Disabled","MultipleSliders","Interactive","FormExample"];export{u as CustomRange,c as Default,h as Disabled,p as FineControl,g as FormExample,b as Interactive,v as MultipleSliders,m as WithLabel,le as __namedExportsOrder,de as default};

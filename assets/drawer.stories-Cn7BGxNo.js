import{i as j,x as F}from"./iframe-Baten_M5.js";import{t}from"./custom-element-C028faeO.js";import{n as w}from"./property-Cny5Lx-H.js";import{D as H,a as N,g as W,b as q,c as A,e as I,f as V}from"./dialog-content-CGEE4zzH.js";import{M as $}from"./modal-surface-CGq7x0bD.js";import{t as G,a as J}from"./index-Bkm5wONK.js";import"./button-Dp4fUmeH.js";import"./preload-helper-BBXEHTOU.js";import"./state-sync-controller-DOYT6Ds6.js";import"./state-CcYsaF-H.js";var K=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,r=(e,a,m,o)=>{for(var s=o>1?void 0:o?Q(a,m):a,u=e.length-1,h;u>=0;u--)(h=e[u])&&(s=(o?h(a,m,s):h(s))||s);return o&&s&&K(a,m,s),s};let b=class extends H{constructor(){super(...arguments),this.dismissible=!0,this.guardEscape=e=>{e.key==="Escape"&&this.open&&!this.dismissible&&(e.preventDefault(),e.stopImmediatePropagation())}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.guardEscape,!0)}disconnectedCallback(){window.removeEventListener("keydown",this.guardEscape,!0),super.disconnectedCallback()}updated(e){super.updated(e),this.querySelectorAll("shadcn-drawer-content").forEach(a=>{a.dismissible=this.dismissible}),e.has("open")&&e.get("open")!==void 0&&this.dispatchEvent(new CustomEvent("drawer-open-change",{bubbles:!0,composed:!0,detail:{open:this.open}}))}};r([w({type:Boolean,reflect:!0})],b.prototype,"dismissible",2);b=r([t("shadcn-drawer")],b);let f=class extends N{};f=r([t("shadcn-drawer-trigger")],f);let g=class extends W{};g=r([t("shadcn-drawer-close")],g);let i=class extends ${constructor(){super(...arguments),this.direction="bottom",this.dismissible=!0,this.titleSelector="shadcn-drawer-title"}get dismissOnBackdrop(){return this.dismissible}};i.styles=[...$.styles,G,J,j`
  ...
  render
}`,...(T=(P=c.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var B,L,M;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    open: true,
    dismissible: false,
    direction: 'bottom'
  ...
  render
}`,...(M=(L=l.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};const oe=["Default","Open","Left","NonDismissible"];export{n as Default,c as Left,l as NonDismissible,d as Open,oe as __namedExportsOrder,ie as default};

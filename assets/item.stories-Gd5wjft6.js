import{i as D,a as P,x as s}from"./iframe-Baten_M5.js";import{t as z}from"./custom-element-C028faeO.js";import{n as V}from"./property-Cny5Lx-H.js";import{t as O}from"./index-Bkm5wONK.js";import"./kbd-XxL63TZ4.js";import"./preload-helper-BBXEHTOU.js";var H=Object.defineProperty,W=Object.getOwnPropertyDescriptor,p=(n,i,h,a)=>{for(var e=a>1?void 0:a?W(i,h):i,m=n.length-1,u;m>=0;m--)(u=n[m])&&(e=(a?u(i,h,e):u(e))||e);return a&&e&&H(i,h,e),e};let t=class extends P{constructor(){super(...arguments),this.disabled=!1,this.selected=!1}render(){return s`
      <div
        part="item"
    ...
    `];p([V({type:Boolean})],t.prototype,"disabled",2);p([V({type:Boolean})],t.prototype,"selected",2);t=p([z("shadcn-item")],t);const Q={title:"Components/Item",component:"shadcn-item",tags:["autodocs"],argTypes:{disabled:{control:"boolean",description:"Whether the item is disabled"},selected:{control:"boolean",description:"Whether the item is selected"}},parameters:{docs:{description:{component:"A generic list item component for use in menus, selects, and command palettes."}}}},d={render:()=>s`
  ...
  `,parameters:{docs:{description:{story:"Complete menu example using items."}}}};var v,f,g;d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 300px;">
      <shadcn-item>Item text</shadcn-item>
    </div>
  \`
}`,...(g=(f=d.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};var k,x,b;o.parameters={...o.parameters,docs:{...(k=o.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 300px; display: flex; flex-direction: column;">
      <shadcn-item>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
}`,...(_=(y=r.parameters)==null?void 0:y.docs)==null?void 0:_.source}}};var B,C,S;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 300px; display: flex; flex-direction: column;">
      <shadcn-item>Default Item</shadcn-item>
      <shadcn-item selected>Selected Item</shadcn-item>
...
}`,...(S=(C=l.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var j,I,M;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 300px; border: 1px solid var(--border); border-radius: var(--radius-md);">
      <div style="padding: 0.5rem;">
        <div style="padding: 0.5rem 0.75rem; font-size: var(--font-size-sm); font-weight: var(--font-semibold); color: var(--foreground);">
...
}`,...(M=(I=c.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};const T=["Default","WithIcon","WithSuffix","States","Menu"];export{d as Default,c as Menu,l as States,o as WithIcon,r as WithSuffix,T as __namedExportsOrder,Q as default};

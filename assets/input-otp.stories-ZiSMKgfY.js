import{i as P,a as T,x as m}from"./iframe-DzFl6Ur1.js";import{t as B}from"./custom-element-C028faeO.js";import{n as s}from"./property-uAZGxRZC.js";import{e as W}from"./query-BApjzB0v.js";import{t as A}from"./index-BCFaqB6o.js";import"./preload-helper-BBXEHTOU.js";var V=Object.defineProperty,j=Object.getOwnPropertyDescriptor,i=(e,t,a,n)=>{for(var o=n>1?void 0:n?j(t,a):t,v=e.length-1,g;v>=0;v--)(g=e[v])&&(o=(n?g(t,a,o):g(o))||o);return n&&o&&V(t,a,o),o};let r=class extends T{constructor(){super(),this.value="",this.length=6,this.mode="numeric",this.name="",this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1,this.ariaLabel="One-time password",this._internals=this.attachInternals()}render(){const e=Array.from({length:Math.max(1,this.length)},(a,n)=>this.value[n]??""),t=Math.min(this.value.length,e.length-1);return m`
      <div class="root">
  ...
  render
}`,...(E=(D=h.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};const H=["Default","WithValue","TextCode","Invalid","Disabled"];export{d as Default,h as Disabled,c as Invalid,p as TextCode,u as WithValue,H as __namedExportsOrder,G as default};

import{i as P,a as j,x as n}from"./iframe-DzFl6Ur1.js";import{t as N}from"./custom-element-C028faeO.js";import{n as t}from"./property-uAZGxRZC.js";import{e as I}from"./query-BApjzB0v.js";import{t as V,f as R}from"./index-BCFaqB6o.js";import"./label-BK8OqBsA.js";import"./preload-helper-BBXEHTOU.js";var G=Object.defineProperty,H=Object.getOwnPropertyDescriptor,r=(a,o,x,d)=>{for(var s=d>1?void 0:d?H(o,x):o,v=a.length-1,g;v>=0;v--)(g=a[v])&&(s=(d?g(o,x,s):g(s))||s);return d&&s&&G(o,x,s),s};let e=class extends j{constructor(){super(...arguments),this.value="",this.placeholder="",this.disabled=!1,this.readonly=!1,this.required=!1,this.error=!1,this.name=""}render(){return n`
    ...
    `];r([I(".textarea")],e.prototype,"textareaElement",2);r([t({type:String})],e.prototype,"value",2);r([t({type:String})],e.prototype,"placeholder",2);r([t({type:Boolean})],e.prototype,"disabled",2);r([t({type:Boolean})],e.prototype,"readonly",2);r([t({type:Boolean})],e.prototype,"required",2);r([t({type:Boolean})],e.prototype,"error",2);r([t({type:String})],e.prototype,"name",2);r([t({type:Number})],e.prototype,"minlength",2);r([t({type:Number})],e.prototype,"maxlength",2);r([t({type:Number})],e.prototype,"rows",2);r([t({type:Number})],e.prototype,"cols",2);e=r([N("shadcn-textarea")],e);const ee={title:"Components/Textarea",component:"shadcn-textarea",tags:["autodocs"],argTypes:{placeholder:{control:"text",description:"Placeholder text"},disabled:{control:"boolean",description:"Whether the textarea is disabled"},error:{control:"boolean",description:"Whether the textarea has an error"}},parameters:{docs:{description:{component:"A multi-line text input with vertical resizing and validation support."}}}},l={render:()=>n`
  ...
  \`
}`,...(O=(A=m.parameters)==null?void 0:A.docs)==null?void 0:O.source}}};const ae=["Default","WithLabel","WithValue","Disabled","WithError","WithMaxLength","FormExample"];export{l as Default,p as Disabled,m as FormExample,h as WithError,i as WithLabel,u as WithMaxLength,c as WithValue,ae as __namedExportsOrder,ee as default};

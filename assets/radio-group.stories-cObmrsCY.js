import{i as F,a as L,x as t}from"./iframe-BV4MdNsM.js";import{t as M}from"./custom-element-C028faeO.js";import{n as r}from"./property-DKYLCqXO.js";import{t as j}from"./index-Fg_qAIbf.js";import"./preload-helper-BBXEHTOU.js";var N=Object.defineProperty,W=Object.getOwnPropertyDescriptor,e=(a,o,i,c)=>{for(var s=c>1?void 0:c?W(o,i):o,g=a.length-1,f;g>=0;g--)(f=a[g])&&(s=(c?f(o,i,s):f(s))||s);return c&&s&&N(o,i,s),s};let d=class extends L{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.required=!1,this.name="",this.value=""}render(){return t`
    ...
    `];e([r({type:String})],n.prototype,"value",2);e([r({type:String})],n.prototype,"name",2);e([r({type:String})],n.prototype,"orientation",2);e([r({type:Boolean})],n.prototype,"disabled",2);e([r({type:Boolean})],n.prototype,"required",2);n=e([M("shadcn-radio-group")],n);const U={title:"Components/Radio Group",component:"shadcn-radio-group",tags:["autodocs"],argTypes:{value:{control:"text",description:"Selected value"},orientation:{control:"radio",options:["vertical","horizontal"],description:"Layout orientation"},disabled:{control:"boolean",description:"Whether the group is disabled"}},parameters:{docs:{description:{component:"A set of radio buttons that allows single selection from multiple options."}}}},l={render:()=>t`
...
}`,...(A=(P=m.parameters)==null?void 0:P.docs)==null?void 0:A.source}}};const J=["Default","WithDefault","Horizontal","Disabled","FormExample","Interactive"];export{l as Default,p as Disabled,v as FormExample,h as Horizontal,m as Interactive,u as WithDefault,J as __namedExportsOrder,U as default};

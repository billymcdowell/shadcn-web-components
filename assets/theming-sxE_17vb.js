import{u as i,j as e,M as o}from"./blocks-D8cQIbLh.js";import"./preload-helper-BBXEHTOU.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-Baten_M5.js";function s(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Guides/Theming"}),`
...
`,e.jsxs(n.p,{children:["shadcn-web-components uses CSS custom properties (CSS variables) for theming. Load the global ",e.jsx(n.code,{children:"tokens.css"})," file described in ",e.jsx(n.strong,{children:"Guides / Getting Started"}),", then override its values to match your application's design system."]}),`
...
`})}),`
`,e.jsx(n.h3,{id:"method-3-load-defaults-and-override",children:"Method 3: Load Defaults and Override"}),`
`,e.jsx(n.p,{children:"Load the published global tokens, then override them in your own stylesheet:"}),`
...
`})}),`
`,e.jsxs(n.p,{children:["The package's ",e.jsx(n.code,{children:"/styles"})," JavaScript subpath exports Lit ",e.jsx(n.code,{children:"CSSResult"}),` helpers. It is
not a global CSS file and cannot be loaded with CSS `,e.jsx(n.code,{children:"@import"})," or ",e.jsx(n.code,{children:"<link>"}),"."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--spacing-1-5"}),": 0.375rem (6px)"]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--transition-base"}),": 300ms cubic-bezier(0.4, 0, 0.2, 1)"]}),`
...
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"--transition-base"})," and ",e.jsx(n.code,{children:"--transition-normal"}),` are equivalent aliases used by
different component families.`]}),`
`,e.jsx(n.h3,{id:"animation-tokens",children:"Animation Tokens"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--animation-spin-duration"}),": 600ms"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--animation-spin-easing"}),": linear"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--animation-pulse-duration"}),": 2s"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--animation-pulse-easing"}),": cubic-bezier(0.4, 0, 0.6, 1)"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--animation-caret-duration"}),": 1s"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--animation-caret-easing"}),": steps(1)"]}),`
`]}),`
`,e.jsxs(n.p,{children:[`These tokens control spinner rotation, skeleton pulsing, and the input OTP caret.
Their components disable keyframe animation when `,e.jsx(n.code,{children:"prefers-reduced-motion: reduce"}),`
is active.`]}),`
`,e.jsx(n.h3,{id:"letter-spacing-tokens",children:"Letter Spacing Tokens"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--tracking-tight"}),": -0.025em"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"--tracking-widest"}),": 0.1em"]}),`
`]}),`
...
`]})]})}function t(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}export{t as default};

import{i as P,a as $,x as n}from"./iframe-CBkYFfHe.js";import{t as D}from"./custom-element-C028faeO.js";import{t as U}from"./index-DHlp-d2y.js";import"./input-2l3-Yg7N.js";import"./button-BilKkZtN.js";import"./preload-helper-BBXEHTOU.js";import"./property-DkYxKTO5.js";import"./query-BApjzB0v.js";var A=Object.getOwnPropertyDescriptor,H=(u,c,O,l)=>{for(var r=l>1?void 0:l?A(c,O):c,a=u.length-1,h;a>=0;a--)(h=u[a])&&(r=h(r)||r);return r};let d=class extends ${render(){return n`
    ...
    `];d=H([D("shadcn-input-group")],d);const Q={title:"Components/Input Group",component:"shadcn-input-group",tags:["autodocs"],parameters:{docs:{description:{component:"A container for grouping inputs with prefix and/or suffix addons."}}}},t={render:()=>n`
...
}`,...(E=(j=p.parameters)==null?void 0:j.docs)==null?void 0:E.source}}};const R=["WithPrefix","WithSuffix","WithBoth","WithIcon","WithButton","Examples"];export{p as Examples,i as WithBoth,s as WithButton,o as WithIcon,t as WithPrefix,e as WithSuffix,R as __namedExportsOrder,Q as default};

import{x as n}from"./iframe-Baten_M5.js";import"./button-Dp4fUmeH.js";import"./preload-helper-BBXEHTOU.js";import"./custom-element-C028faeO.js";import"./property-Cny5Lx-H.js";import"./index-Bkm5wONK.js";const L={title:"Components/Button",component:"shadcn-button",tags:["autodocs"],argTypes:{variant:{control:"select",options:["default","destructive","outline","secondary","ghost","link"],description:"Visual style variant of the button"},size:{control:"select",options:["default","sm","lg","icon"],description:"Size variant of the button"},disabled:{control:"boolean",description:"Whether the button is disabled"},type:{control:"select",options:["button","submit","reset"],description:"Button type attribute"}},parameters:{docs:{description:{component:"A versatile button component with multiple variants and sizes, following shadcn design principles."}}}},t={args:{variant:"default",size:"default",disabled:!1},render:d=>n`
  ...
  `,parameters:{docs:{description:{story:"All available button sizes"}}}},o={render:()=>n`
  ...
  `,parameters:{docs:{description:{story:"Icon buttons with the icon size variant"}}}},s={render:()=>n`
...
}`,...(g=(v=e.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var m,w,k;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; gap: 1rem; padding: 1rem; background: var(--background);">
      <shadcn-button size="icon" variant="default">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
}`,...(k=(w=o.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var f,x,y;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; gap: 1rem; flex-wrap: wrap; padding: 1rem; background: var(--background);">
      <shadcn-button variant="default" disabled>Default</shadcn-button>
      <shadcn-button variant="destructive" disabled>Destructive</shadcn-button>
...
}`,...(y=(x=s.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var z,B,S;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; gap: 1rem; flex-wrap: wrap; padding: 1rem; background: var(--background);">
      <shadcn-button>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
}`,...(S=(B=r.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};const $=["Default","AllVariants","AllSizes","IconButton","Disabled","WithIcons"];export{e as AllSizes,a as AllVariants,t as Default,s as Disabled,o as IconButton,r as WithIcons,$ as __namedExportsOrder,L as default};

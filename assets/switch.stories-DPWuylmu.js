import{i as R,a as E,x as n}from"./iframe-DzFl6Ur1.js";import{t as P}from"./custom-element-C028faeO.js";import{n as r}from"./property-uAZGxRZC.js";import{t as W}from"./index-BCFaqB6o.js";import"./preload-helper-BBXEHTOU.js";var q=Object.defineProperty,B=Object.getOwnPropertyDescriptor,a=(e,t,p,d)=>{for(var s=d>1?void 0:d?B(t,p):t,u=e.length-1,f;u>=0;u--)(f=e[u])&&(s=(d?f(t,p,s):f(s))||s);return d&&s&&q(t,p,s),s};let i=class extends E{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.required=!1,this.name="",this.value=""}render(){return n`
    ...
    `];a([r({type:Boolean})],i.prototype,"checked",2);a([r({type:Boolean})],i.prototype,"disabled",2);a([r({type:Boolean})],i.prototype,"required",2);a([r({type:String})],i.prototype,"name",2);a([r({type:String})],i.prototype,"value",2);i=a([P("shadcn-switch")],i);const L={title:"Components/Switch",component:"shadcn-switch",tags:["autodocs"],argTypes:{checked:{control:"boolean",description:"Whether the switch is checked"},disabled:{control:"boolean",description:"Whether the switch is disabled"}},parameters:{docs:{description:{component:"A toggle switch component with smooth animations and full accessibility."}}}},o={render:()=>n`

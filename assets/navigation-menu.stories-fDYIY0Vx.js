import{i as o,a as r,x as a}from"./iframe-DQoeDK16.js";import{t as s}from"./custom-element-C028faeO.js";import{n as x}from"./property-B_PCvBji.js";import{r as _}from"./state-55U8sqXg.js";import{t as d}from"./index-BAD6FfhH.js";import"./preload-helper-BBXEHTOU.js";var S=Object.defineProperty,C=Object.getOwnPropertyDescriptor,n=(i,e,p,l)=>{for(var t=l>1?void 0:l?C(e,p):e,h=i.length-1,f;h>=0;h--)(f=i[h])&&(t=(l?f(e,p,t):f(t))||t);return l&&t&&S(e,p,t),t};let y=class extends r{render(){return a`
    ...
    `];n([x({type:String})],v.prototype,"href",2);v=n([s("shadcn-navigation-menu-link")],v);const O={title:"Components/Navigation Menu",component:"shadcn-navigation-menu",tags:["autodocs"],parameters:{docs:{description:{component:"A collection of links for navigating websites."}}}},c={render:()=>a`
  ...
  \`
}`,...(z=(k=c.parameters)==null?void 0:k.docs)==null?void 0:z.source}}};const P=["Default"];export{c as Default,P as __namedExportsOrder,O as default};

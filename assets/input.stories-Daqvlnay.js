import{x as e}from"./iframe-B5y9qznB.js";import"./input-Da_5sCzn.js";import"./label-CRDgeI4a.js";import"./preload-helper-BBXEHTOU.js";import"./custom-element-C028faeO.js";import"./property-DwCo9F1Y.js";import"./query-TLA3Feqw.js";import"./base-CShCMygk.js";import"./index-BBGFRwet.js";const P={title:"Components/Input",component:"shadcn-input",tags:["autodocs"],argTypes:{type:{control:"select",options:["text","email","password","search","tel","url","number"],description:"Input type"},value:{control:"text",description:"Input value"},placeholder:{control:"text",description:"Placeholder text"},disabled:{control:"boolean",description:"Whether the input is disabled"},error:{control:"boolean",description:"Whether the input has an error"}},parameters:{docs:{description:{component:"A text input component with support for various input types, validation, and error states."}}}},a={args:{type:"text",placeholder:"Enter text..."},render:n=>e`
  ...
  `,parameters:{docs:{description:{story:"Example form with multiple inputs."}}}};var t,s,p;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    type: 'text',
  ...
  \`
}`,...(p=(s=a.parameters)==null?void 0:s.docs)==null?void 0:p.source}}};var c,o,m;l.parameters={...l.parameters,docs:{...(c=l.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 400px; display: flex; flex-direction: column; gap: 0.5rem;">
      <shadcn-label for="email">Email</shadcn-label>
      <shadcn-input
...
}`,...(w=(g=i.parameters)==null?void 0:g.docs)==null?void 0:w.source}}};const z=["Default","WithLabel","DifferentTypes","States","FormExample"];export{a as Default,d as DifferentTypes,i as FormExample,r as States,l as WithLabel,z as __namedExportsOrder,P as default};

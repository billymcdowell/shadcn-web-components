import{i as W,a as K,x as d}from"./iframe-DzFl6Ur1.js";import{t as H}from"./custom-element-C028faeO.js";import{n as o}from"./property-uAZGxRZC.js";import{r as X}from"./state-BR31m5Xj.js";import{e as T}from"./query-BApjzB0v.js";import{t as q}from"./index-BCFaqB6o.js";import"./label-BK8OqBsA.js";import"./preload-helper-BBXEHTOU.js";var G=Object.defineProperty,J=Object.getOwnPropertyDescriptor,t=(e,a,n,i)=>{for(var r=i>1?void 0:i?J(a,n):a,l=e.length-1,f;l>=0;l--)(f=e[l])&&(r=(i?f(a,n,r):f(r))||r);return i&&r&&G(a,n,r),r};let s=class extends K{constructor(){super(...arguments),this.value=50,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.name="",this._isDragging=!1}render(){const e=(this.value-this.min)/(this.max-this.min)*100;return d`
    ...
    `];t([T(".slider__track")],s.prototype,"trackElement",2);t([T(".slider__thumb")],s.prototype,"thumbElement",2);t([o({type:Number})],s.prototype,"value",2);t([o({type:Number})],s.prototype,"min",2);t([o({type:Number})],s.prototype,"max",2);t([o({type:Number})],s.prototype,"step",2);t([o({type:Boolean})],s.prototype,"disabled",2);t([o({type:String})],s.prototype,"name",2);t([X()],s.prototype,"_isDragging",2);s=t([H("shadcn-slider")],s);const ie={title:"Components/Slider",component:"shadcn-slider",tags:["autodocs"],argTypes:{value:{control:{type:"number",min:0,max:100},description:"Current value"},min:{control:"number",description:"Minimum value"},max:{control:"number",description:"Maximum value"},step:{control:"number",description:"Step increment"},disabled:{control:"boolean",description:"Whether the slider is disabled"}},parameters:{docs:{description:{component:"A slider input for selecting a value from a range with mouse/touch drag and keyboard support."}}}},c={render:()=>d`
  ...
  \`
}`,...(N=(U=g.parameters)==null?void 0:U.docs)==null?void 0:N.source}}};const te=["Default","WithLabel","CustomRange","FineControl","Disabled","MultipleSliders","Interactive","FormExample"];export{u as CustomRange,c as Default,h as Disabled,p as FineControl,g as FormExample,b as Interactive,v as MultipleSliders,m as WithLabel,te as __namedExportsOrder,ie as default};

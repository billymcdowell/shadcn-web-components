import{i as D,a as P,x as e}from"./iframe-Baten_M5.js";import{t as j}from"./custom-element-C028faeO.js";import{n as k}from"./property-Cny5Lx-H.js";import{t as B}from"./index-Bkm5wONK.js";import"./preload-helper-BBXEHTOU.js";var H=Object.defineProperty,L=Object.getOwnPropertyDescriptor,h=(t,s,v,i)=>{for(var n=i>1?void 0:i?L(s,v):s,m=t.length-1,p;m>=0;m--)(p=t[m])&&(n=(i?p(s,v,n):p(n))||n);return i&&n&&H(s,v,n),n};let a=class extends P{constructor(){super(...arguments),this.variant="default",this.width="",this.height=""}render(){const t=[];return this.width&&t.push(`width: ${this.width}`),this.height&&t.push(`height: ${this.height}`),e`
      <div
        part="skeleton"
  ...
  \`
}`,...(T=(O=c.parameters)==null?void 0:O.docs)==null?void 0:T.source}}};const I=["Default","Variants","CardSkeleton","ListSkeleton","TableSkeleton"];export{o as CardSkeleton,r as Default,l as ListSkeleton,c as TableSkeleton,d as Variants,I as __namedExportsOrder,G as default};

import{i as P,a as j,x as n}from"./iframe-Baten_M5.js";import{t as N}from"./custom-element-C028faeO.js";import{n as t}from"./property-Cny5Lx-H.js";import{e as I}from"./query-TLA3Feqw.js";import{t as V,f as R}from"./index-Bkm5wONK.js";import"./label-z5LBJa38.js";import"./preload-helper-BBXEHTOU.js";import"./base-CShCMygk.js";var G=Object.defineProperty,H=Object.getOwnPropertyDescriptor,r=(a,o,x,d)=>{for(var s=d>1?void 0:d?H(o,x):o,v=a.length-1,g;v>=0;v--)(g=a[v])&&(s=(d?g(o,x,s):g(s))||s);return d&&s&&G(o,x,s),s};let e=class extends j{constructor(){super(...arguments),this.value="",this.placeholder="",this.disabled=!1,this.readonly=!1,this.required=!1,this.error=!1,this.name=""}render(){return n`
    ...
    `];r([I(".textarea")],e.prototype,"textareaElement",2);r([t({type:String})],e.prototype,"value",2);r([t({type:String})],e.prototype,"placeholder",2);r([t({type:Boolean})],e.prototype,"disabled",2);r([t({type:Boolean})],e.prototype,"readonly",2);r([t({type:Boolean})],e.prototype,"required",2);r([t({type:Boolean})],e.prototype,"error",2);r([t({type:String})],e.prototype,"name",2);r([t({type:Number})],e.prototype,"minlength",2);r([t({type:Number})],e.prototype,"maxlength",2);r([t({type:Number})],e.prototype,"rows",2);r([t({type:Number})],e.prototype,"cols",2);e=r([N("shadcn-textarea")],e);const ae={title:"Components/Textarea",component:"shadcn-textarea",tags:["autodocs"],argTypes:{placeholder:{control:"text",description:"Placeholder text"},disabled:{control:"boolean",description:"Whether the textarea is disabled"},error:{control:"boolean",description:"Whether the textarea has an error"}},parameters:{docs:{description:{component:"A multi-line text input with vertical resizing and validation support."}}}},l={render:()=>n`
  ...
  \`
}`,...(W=(S=p.parameters)==null?void 0:S.docs)==null?void 0:W.source}}};var B,C,q;h.parameters={...h.parameters,docs:{...(B=h.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 500px; display: flex; flex-direction: column; gap: 0.5rem;">
      <shadcn-label>Bio</shadcn-label>
      <shadcn-textarea
  ...
  \`
}`,...(q=(C=h.parameters)==null?void 0:C.docs)==null?void 0:q.source}}};var D,F,L;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background); max-width: 500px; display: flex; flex-direction: column; gap: 0.5rem;">
      <div style="display: flex; justify-content: space-between;">
        <shadcn-label>Comment</shadcn-label>
  ...
  \`
}`,...(O=(A=m.parameters)==null?void 0:A.docs)==null?void 0:O.source}}};const re=["Default","WithLabel","WithValue","Disabled","WithError","WithMaxLength","FormExample"];export{l as Default,p as Disabled,m as FormExample,h as WithError,i as WithLabel,u as WithMaxLength,c as WithValue,re as __namedExportsOrder,ae as default};

import{i as j,a as z,x as o}from"./iframe-DQoeDK16.js";import{t as B}from"./custom-element-C028faeO.js";import{n as t}from"./property-B_PCvBji.js";import{e as I}from"./query-BApjzB0v.js";import{t as F}from"./index-BAD6FfhH.js";import"./label-CFHHHACB.js";import"./preload-helper-BBXEHTOU.js";var K=Object.defineProperty,L=Object.getOwnPropertyDescriptor,a=(e,c,s,d)=>{for(var r=d>1?void 0:d?L(c,s):c,m=e.length-1,x;m>=0;m--)(x=e[m])&&(r=(d?x(c,s,r):x(r))||r);return d&&r&&K(c,s,r),r};let n=class extends z{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.required=!1,this.name="",this.value=""}render(){return o`
    ...
    `];a([I(".checkbox__input")],n.prototype,"inputElement",2);a([t({type:Boolean})],n.prototype,"checked",2);a([t({type:Boolean})],n.prototype,"disabled",2);a([t({type:Boolean})],n.prototype,"required",2);a([t({type:String})],n.prototype,"name",2);a([t({type:String})],n.prototype,"value",2);n=a([B("shadcn-checkbox")],n);const U={title:"Components/Checkbox",component:"shadcn-checkbox",tags:["autodocs"],argTypes:{checked:{control:"boolean",description:"Whether the checkbox is checked"},disabled:{control:"boolean",description:"Whether the checkbox is disabled"}},parameters:{docs:{description:{component:"A checkbox input with WCAG 2.1 AA compliant accessibility and keyboard support."}}}},i={render:()=>o`
...
}`,...(W=(R=k.parameters)==null?void 0:R.docs)==null?void 0:W.source}}};const V=["Default","Checked","Disabled","WithLabel","FormExample","Interactive"];export{h as Checked,i as Default,l as Disabled,b as FormExample,k as Interactive,p as WithLabel,V as __namedExportsOrder,U as default};

import{i as C,a as D,x as n}from"./iframe-Baten_M5.js";import{t as L}from"./custom-element-C028faeO.js";import{n as P}from"./property-Cny5Lx-H.js";import{t as A}from"./index-Bkm5wONK.js";import"./preload-helper-BBXEHTOU.js";var O=Object.defineProperty,j=Object.getOwnPropertyDescriptor,_=(r,s,l,i)=>{for(var e=i>1?void 0:i?j(s,l):s,c=r.length-1,m;c>=0;c--)(m=r[c])&&(e=(i?m(s,l,e):m(e))||e);return i&&e&&O(s,l,e),e};let p=class extends D{constructor(){super(...arguments),this.size="default"}render(){return n`
      <div
        part="spinner"
    ...
    `];_([P({type:String})],p.prototype,"size",2);p=_([L("shadcn-spinner")],p);const T={title:"Components/Spinner",component:"shadcn-spinner",tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","default","lg"],description:"Size of the spinner"}},parameters:{docs:{description:{component:"A loading spinner to indicate loading states. Respects prefers-reduced-motion for accessibility."}}}},a={args:{size:"default"},render:r=>n`
...
}`,...(S=(k=d.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};const q=["Default","AllSizes","InButton","Centered"];export{t as AllSizes,d as Centered,a as Default,o as InButton,q as __namedExportsOrder,T as default};

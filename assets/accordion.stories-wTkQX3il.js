import{i as _,a as A,x as c}from"./iframe-BV4MdNsM.js";import{t as C}from"./custom-element-C028faeO.js";import{n as d}from"./property-DKYLCqXO.js";import{t as W}from"./index-Fg_qAIbf.js";import"./preload-helper-BBXEHTOU.js";var E=Object.defineProperty,P=Object.getOwnPropertyDescriptor,s=(n,o,e,t)=>{for(var a=t>1?void 0:t?P(o,e):o,h=n.length-1,u;h>=0;h--)(u=n[h])&&(a=(t?u(o,e,a):u(a))||a);return t&&a&&E(o,e,a),a};let r=class extends A{constructor(){super(...arguments),this.open=!1,this.value=""}render(){return c`
    ...
    `];s([d({type:String})],i.prototype,"type",2);s([d({type:String})],i.prototype,"value",2);s([d({type:Boolean})],i.prototype,"collapsible",2);i=s([C("shadcn-accordion")],i);const D={title:"Components/Accordion",component:"shadcn-accordion",tags:["autodocs"],argTypes:{type:{control:"radio",options:["single","multiple"],description:"Selection mode"},collapsible:{control:"boolean",description:"Allow collapsing all items (single mode only)"}},parameters:{docs:{description:{component:"A vertical stack of collapsible sections with support for single or multiple expansion."}}}},l={render:()=>c`
  ...
  \`
}`,...(k=(I=m.parameters)==null?void 0:I.docs)==null?void 0:k.source}}};const O=["Default","Multiple","FAQ"];export{l as Default,m as FAQ,p as Multiple,O as __namedExportsOrder,D as default};

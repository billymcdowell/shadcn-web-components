import{i as F,x as H}from"./iframe-B5y9qznB.js";import{t as s}from"./custom-element-C028faeO.js";import{n as $}from"./property-DwCo9F1Y.js";import{D as A,a as N,g as V,b as W,c as q,e as G,f as I}from"./dialog-Byha1DWp.js";import{M as B}from"./modal-surface-DiTUHay2.js";import{t as J}from"./index-BBGFRwet.js";import"./button-DKUyPVem.js";import"./input-Da_5sCzn.js";import"./preload-helper-BBXEHTOU.js";import"./state-sync-controller-DOYT6Ds6.js";import"./state-dZZicvxP.js";import"./query-TLA3Feqw.js";import"./base-CShCMygk.js";var K=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,t=(e,r,l,a)=>{for(var o=a>1?void 0:a?Q(r,l):r,m=e.length-1,u;m>=0;m--)(u=e[m])&&(o=(a?u(r,l,o):u(o))||o);return a&&o&&K(r,l,o),o};let g=class extends A{updated(e){super.updated(e),e.has("open")&&e.get("open")!==void 0&&this.dispatchEvent(new CustomEvent("sheet-open-change",{bubbles:!0,composed:!0,detail:{open:this.open}}))}};g=t([s("shadcn-sheet")],g);let f=class extends N{};f=t([s("shadcn-sheet-trigger")],f);let b=class extends V{};b=t([s("shadcn-sheet-close")],b);let c=class extends B{constructor(){super(...arguments),this.side="right",this.titleSelector="shadcn-sheet-title"}};c.styles=[...B.styles,J,F`
  ...
  `];t([$({type:String,reflect:!0})],c.prototype,"side",2);c=t([s("shadcn-sheet-content")],c);let v=class extends W{};v=t([s("shadcn-sheet-title")],v);let S=class extends q{};S=t([s("shadcn-sheet-description")],S);let x=class extends G{};x=t([s("shadcn-sheet-header")],x);let D=class extends I{};D=t([s("shadcn-sheet-footer")],D);const ie={title:"Components/Sheet",component:"shadcn-sheet",tags:["autodocs"],argTypes:{open:{control:"boolean",description:"Whether the sheet is open."},side:{control:"select",options:["top","right","bottom","left"],description:"Viewport edge for the panel."}}},p=e=>H`
  ...
  render
}`,...(j=(M=h.parameters)==null?void 0:M.docs)==null?void 0:j.source}}};const de=["Default","Left","Top","Bottom"];export{h as Bottom,n as Default,i as Left,d as Top,de as __namedExportsOrder,ie as default};

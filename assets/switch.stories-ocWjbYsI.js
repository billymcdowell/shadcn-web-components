import{i as R,a as B,x as n}from"./iframe-Baten_M5.js";import{t as E}from"./custom-element-C028faeO.js";import{n as r}from"./property-Cny5Lx-H.js";import{t as P}from"./index-Bkm5wONK.js";import"./preload-helper-BBXEHTOU.js";var W=Object.defineProperty,q=Object.getOwnPropertyDescriptor,a=(e,t,p,d)=>{for(var s=d>1?void 0:d?q(t,p):t,u=e.length-1,f;u>=0;u--)(f=e[u])&&(s=(d?f(t,p,s):f(s))||s);return d&&s&&W(t,p,s),s};let i=class extends B{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.required=!1,this.name="",this.value=""}render(){return n`
      <div
        part="switch"
    ...
    `];a([r({type:Boolean})],i.prototype,"checked",2);a([r({type:Boolean})],i.prototype,"disabled",2);a([r({type:Boolean})],i.prototype,"required",2);a([r({type:String})],i.prototype,"name",2);a([r({type:String})],i.prototype,"value",2);i=a([E("shadcn-switch")],i);const L={title:"Components/Switch",component:"shadcn-switch",tags:["autodocs"],argTypes:{checked:{control:"boolean",description:"Whether the switch is checked"},disabled:{control:"boolean",description:"Whether the switch is disabled"}},parameters:{docs:{description:{component:"A toggle switch component with smooth animations and full accessibility."}}}},o={render:()=>n`
  ...
  \`
}`,...(C=(N=v.parameters)==null?void 0:N.docs)==null?void 0:C.source}}};const T=["Default","Checked","Disabled","WithLabels","Settings"];export{c as Checked,o as Default,l as Disabled,v as Settings,h as WithLabels,T as __namedExportsOrder,L as default};

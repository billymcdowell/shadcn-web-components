import{i as m,a as f,x as l}from"./iframe-DzFl6Ur1.js";import{t as y}from"./custom-element-C028faeO.js";import{n as w}from"./property-uAZGxRZC.js";import{t as k}from"./index-BCFaqB6o.js";import"./button-1iZ6Rw4P.js";import"./separator-D3u4XxLu.js";import"./preload-helper-BBXEHTOU.js";var j=Object.defineProperty,C=Object.getOwnPropertyDescriptor,b=(c,e,o,a)=>{for(var t=a>1?void 0:a?C(e,o):e,d=c.length-1,i;d>=0;d--)(i=c[d])&&(t=(a?i(e,o,t):i(t))||t);return a&&t&&j(e,o,t),t};let s=class extends f{constructor(){super(...arguments),this.collapsed=!1}render(){return l`
      <aside class="sidebar">
        <slot></slot>
      </aside>
    `}};s.styles=[k,m`
    ...
    `];b([w({type:Boolean,reflect:!0})],s.prototype,"collapsed",2);s=b([y("shadcn-sidebar")],s);const B={title:"Components/Sidebar",component:"shadcn-sidebar",tags:["autodocs"],argTypes:{collapsed:{control:"boolean",description:"Whether the sidebar is collapsed"}},parameters:{docs:{description:{component:"A composable sidebar component."}}}},r={render:()=>l`
  ...
  \`
}`,...(x=(u=n.parameters)==null?void 0:u.docs)==null?void 0:x.source}}};const O=["Default","Collapsed"];export{n as Collapsed,r as Default,O as __namedExportsOrder,B as default};

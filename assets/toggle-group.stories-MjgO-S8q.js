import{i as U,a as W,x as r}from"./iframe-Baten_M5.js";import{t as $}from"./custom-element-C028faeO.js";import{n as v}from"./property-Cny5Lx-H.js";import{t as G}from"./index-Bkm5wONK.js";import"./toggle-C-sJokyS.js";import"./preload-helper-BBXEHTOU.js";var P=Object.defineProperty,q=Object.getOwnPropertyDescriptor,s=(t,o,e,n)=>{for(var l=n>1?void 0:n?q(o,e):o,x=t.length-1,y;x>=0;x--)(y=t[x])&&(l=(n?y(o,e,l):y(l))||l);return n&&l&&P(o,e,l),l};let g=class extends W{constructor(){super(...arguments),this.type="single",this.value="",this.orientation="horizontal",this.disabled=!1}render(){return r`
      <div
        part="toggle-group"
    ...
    `];s([v({type:String})],g.prototype,"type",2);s([v({type:String})],g.prototype,"value",2);s([v({type:String})],g.prototype,"orientation",2);s([v({type:Boolean})],g.prototype,"disabled",2);g=s([$("shadcn-toggle-group")],g);const X={title:"Components/Toggle Group",component:"shadcn-toggle-group",tags:["autodocs"],argTypes:{type:{control:"radio",options:["single","multiple"],description:"Selection type"},orientation:{control:"radio",options:["horizontal","vertical"],description:"Layout orientation"},disabled:{control:"boolean",description:"Whether the group is disabled"}},parameters:{docs:{description:{component:"A group of toggle buttons with single or multiple selection modes."}}}},i={render:()=>r`
  ...
  \`
}`,...(I=(H=p.parameters)==null?void 0:H.docs)==null?void 0:I.source}}};const Y=["Default","Single","Multiple","WithIcons","Vertical","Disabled","TextEditor"];export{i as Default,u as Disabled,d as Multiple,a as Single,p as TextEditor,h as Vertical,c as WithIcons,Y as __namedExportsOrder,X as default};

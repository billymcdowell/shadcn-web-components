import{i as j,x as F}from"./iframe-BV4MdNsM.js";import{t}from"./custom-element-C028faeO.js";import{n as b}from"./property-DKYLCqXO.js";import{D as H,a as N,g as W,b as q,c as A,e as I,f as V}from"./dialog-DdgGj6V0.js";import{M as $}from"./modal-surface-CDUz2ODE.js";import{t as G}from"./index-Fg_qAIbf.js";import"./button-Cs31NNOL.js";import"./preload-helper-BBXEHTOU.js";import"./state-sync-controller-DOYT6Ds6.js";import"./state-PSB6xKTT.js";var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,r=(e,a,u,o)=>{for(var s=o>1?void 0:o?K(a,u):a,m=e.length-1,h;m>=0;m--)(h=e[m])&&(s=(o?h(a,u,s):h(s))||s);return o&&s&&J(a,u,s),s};let w=class extends H{constructor(){super(...arguments),this.dismissible=!0,this.guardEscape=e=>{e.key==="Escape"&&this.open&&!this.dismissible&&(e.preventDefault(),e.stopImmediatePropagation())}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.guardEscape,!0)}disconnectedCallback(){window.removeEventListener("keydown",this.guardEscape,!0),super.disconnectedCallback()}updated(e){super.updated(e),this.querySelectorAll("shadcn-drawer-content").forEach(a=>{a.dismissible=this.dismissible}),e.has("open")&&e.get("open")!==void 0&&this.dispatchEvent(new CustomEvent("drawer-open-change",{bubbles:!0,composed:!0,detail:{open:this.open}}))}};r([b({type:Boolean,reflect:!0})],w.prototype,"dismissible",2);w=r([t("shadcn-drawer")],w);let g=class extends N{};g=r([t("shadcn-drawer-trigger")],g);let f=class extends W{};f=r([t("shadcn-drawer-close")],f);let i=class extends ${constructor(){super(...arguments),this.direction="bottom",this.dismissible=!0,this.titleSelector="shadcn-drawer-title"}get dismissOnBackdrop(){return this.dismissible}};i.styles=[...$.styles,G,j`

import{i as P,a as T,x as m}from"./iframe-B5y9qznB.js";import{t as B}from"./custom-element-C028faeO.js";import{n as s}from"./property-DwCo9F1Y.js";import{e as W}from"./query-TLA3Feqw.js";import{t as A}from"./index-BBGFRwet.js";import"./preload-helper-BBXEHTOU.js";import"./base-CShCMygk.js";var V=Object.defineProperty,j=Object.getOwnPropertyDescriptor,i=(e,t,a,n)=>{for(var o=n>1?void 0:n?j(t,a):t,v=e.length-1,g;v>=0;v--)(g=e[v])&&(o=(n?g(t,a,o):g(o))||o);return n&&o&&V(t,a,o),o};let r=class extends T{constructor(){super(),this.value="",this.length=6,this.mode="numeric",this.name="",this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1,this.ariaLabel="One-time password",this._internals=this.attachInternals()}render(){const e=Array.from({length:Math.max(1,this.length)},(a,n)=>this.value[n]??""),t=Math.min(this.value.length,e.length-1);return m`
      <div class="root">

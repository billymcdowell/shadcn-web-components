import{i as P,a as $,x as n}from"./iframe-B5y9qznB.js";import{t as D}from"./custom-element-C028faeO.js";import{t as U}from"./index-BBGFRwet.js";import"./input-Da_5sCzn.js";import"./button-DKUyPVem.js";import"./preload-helper-BBXEHTOU.js";import"./property-DwCo9F1Y.js";import"./query-TLA3Feqw.js";import"./base-CShCMygk.js";var A=Object.getOwnPropertyDescriptor,H=(u,c,O,l)=>{for(var r=l>1?void 0:l?A(c,O):c,a=u.length-1,h;a>=0;a--)(h=u[a])&&(r=h(r)||r);return r};let d=class extends ${render(){return n`
    ...
    `];d=H([D("shadcn-input-group")],d);const R={title:"Components/Input Group",component:"shadcn-input-group",tags:["autodocs"],parameters:{docs:{description:{component:"A container for grouping inputs with prefix and/or suffix addons."}}}},t={render:()=>n`
...
}`,...(E=(j=p.parameters)==null?void 0:j.docs)==null?void 0:E.source}}};const T=["WithPrefix","WithSuffix","WithBoth","WithIcon","WithButton","Examples"];export{p as Examples,i as WithBoth,s as WithButton,o as WithIcon,t as WithPrefix,e as WithSuffix,T as __namedExportsOrder,R as default};

import{i as n,a as d,x as r}from"./iframe-Baten_M5.js";import{t as c}from"./custom-element-C028faeO.js";import{n as z}from"./property-Cny5Lx-H.js";import{t as s}from"./index-Bkm5wONK.js";import"./preload-helper-BBXEHTOU.js";var E=Object.defineProperty,I=Object.getOwnPropertyDescriptor,e=(x,b,l,m)=>{for(var a=m>1?void 0:m?I(b,l):b,p=x.length-1,g;p>=0;p--)(g=x[p])&&(a=(m?g(b,l,a):g(a))||a);return m&&a&&E(b,l,a),a};let v=class extends d{render(){return r`
    ...
    `];y=e([c("shadcn-breadcrumb-ellipsis")],y);const J={title:"Components/Breadcrumb",component:"shadcn-breadcrumb",tags:["autodocs"],parameters:{docs:{description:{component:"Displays the path to the current resource using a hierarchy of links."}}}},o={render:()=>r`
  ...
  `};var B,C,D;o.parameters={...o.parameters,docs:{...(B=o.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background);">
      <shadcn-breadcrumb>
        <shadcn-breadcrumb-item>
  ...
  \`
}`,...(D=(C=o.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};var j,S,H;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding: 1rem; background: var(--background);">
      <shadcn-breadcrumb>
        <shadcn-breadcrumb-item>
  ...
  \`
}`,...($=(W=h.parameters)==null?void 0:W.docs)==null?void 0:$.source}}};const K=["Default","WithCustomSeparator","Collapsed","WithDropdown"];export{u as Collapsed,o as Default,i as WithCustomSeparator,h as WithDropdown,K as __namedExportsOrder,J as default};
